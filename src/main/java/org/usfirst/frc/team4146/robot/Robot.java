...
public class Robot extends SampleRobot {
	...
	public Robot() {
	 ...
	 /* quick and dirty plotter to smartdash */
	  PlotThread _plotThread = new PlotThread(RobotMap.motionProfileTalon);
	...
	public void robotInit() {
        ...
        _config.neutralDeadband = RobotMap.kNeutralDeadband; /* 0.1 % super small for best low-speed control */
        _config.slot0.kF = RobotMap.kGains_MotProf.kF;
        _config.slot0.kP = RobotMap.kGains_MotProf.kP;
        _config.slot0.kI = RobotMap.kGains_MotProf.kI;
        _config.slot0.kD = RobotMap.kGains_MotProf.kD;
        _config.slot0.integralZone = (int) RobotMap.kGains_MotProf.kIzone;
        _config.slot0.closedLoopPeakOutput = RobotMap.kGains_MotProf.kPeakOutput;
        ...
        RobotMap.motionProfileTalon.configAllSettings(_config);

        /* pick the sensor phase and desired direction */
        RobotMap.motionProfileTalon.setSensorPhase(true);
		RobotMap.motionProfileTalon.setInverted(false);
	}
		...
		while (isOperatorControl() && isEnabled()) {
			...
			switch (_state) {
				...
				case 1:
					...
					RobotMap.motionProfileTalon.startMotionProfile(_bufferedStream, 10, ControlMode.MotionProfile);
					_state = 2;
